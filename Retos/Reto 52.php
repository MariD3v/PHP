...
a. Nombre (dato requerido, sólo puede contener datos y espacios).
b. Correo electrónico (dato requerido, que contenga un email válido con @ y .).
c. Contraseña (dato requerido, con al menos 8 caracteres, una mayúscula, una minúscula y un número).
d. Teléfono (dato opcional, sólo contiene 6 dígitos).
e. Género (dato requerido).
